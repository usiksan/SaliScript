/*
  ...
  Описание
    ...
    24.01.2020 v0.8  Добавил автоматическое обновление таблицы символов при обновлении файла elf
               v0.9  Добавил сортировку таблицы символов для удобства чтения
*/
