...
*/
#ifndef SVVMBYTECODE_H
#define SVVMBYTECODE_H

/*!
   \brief The SvVmByteCode enum перечень кодов команд виртуальной машины
    ...
    представлена одним байтом. Все коды команд перечислены в SvVmByteCode.
