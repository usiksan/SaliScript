...
void SvVpuCompiler::gValue(SvProgramm *prog, SvValue *val, bool keepValue, bool address)
  {
  ...
  switch( val->code() ) {
    ...
    case svvVariable :  //Переменная (глобальная, локальная, параметр, член от this)
      ...
      gvvVariable( prog, dynamic_cast<SvValueVariable*>(val), keepValue, address );
      break;

    case svvFunction :    //Функция (глобальная, член от this)
      //Загрузить адрес функции
      gvvFunction( prog, dynamic_cast<SvValueFunction*>(val), keepValue, address );
      break;
    ...
    case svvCatchFun :
      gValueCatchFun( prog, dynamic_cast<SvValueCatchFun*>(val) );
      break;

    case svvThrowFun :
      gValueThrowFun( prog, dynamic_cast<SvValueThrowFun*>(val) );
      break;

    case svvMemberVariable :  //Член от произвольной структуры структуры
      gvvMemberVariable( prog, dynamic_cast<SvValueMemberVariable*>(val), keepValue, address );
      break;

    case svvConstInt :      //Константа
      gvvConstInt( prog, dynamic_cast<SvValueConstInt*>(val), keepValue, address );
      break;

    case svvConstString :
      gvvConstString( prog, dynamic_cast<SvValueConstString*>(val), keepValue, address );
      break;

    case svvPointer :
      gvvPointer( prog, dynamic_cast<SvValuePointer*>(val), keepValue, address );
      break;

    case svvAddress :
      gvvAddress( prog, dynamic_cast<SvValueAddress*>(val), keepValue, address );
      break;

    case svvPredInc :
      gvvPredInc( prog, dynamic_cast<SvValuePredInc*>(val), keepValue, address );
      break;

    case svvPredDec :
      gvvPredDec( prog, dynamic_cast<SvValuePredDec*>(val), keepValue, address );
      break;

    case svvPostInc :
      gvvPostInc( prog, dynamic_cast<SvValuePostInc*>(val), keepValue, address );
      break;

    case svvPostDec :
      gvvPostDec( prog, dynamic_cast<SvValuePostDec*>(val), keepValue, address );
      break;

    case svvNot :
      gvvNot( prog, dynamic_cast<SvValueBitNot*>(val), keepValue, address );
      break;

    case svvLogNot :
      gvvLogNot( prog, dynamic_cast<SvValueLogNot*>(val), keepValue, address );
      break;

    case svvNeg :
      gvvNeg( prog, dynamic_cast<SvValueNeg*>(val), keepValue, address );
      break;

    case svvStore :
      gvvStore( prog, dynamic_cast<SvValueStore*>(val), keepValue, address );
      break;

    case svvArrayCell :      //Операция индекса массива
      gvvArrayCell( prog, dynamic_cast<SvValueArrayCell*>(val), keepValue, address );
      break;

    case svvMul :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_MUL, QString("VBC1_MUL") );
      break;

    case svvMulStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_MUL, QString("VBC1_MUL") );
      break;

    case svvDiv :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_DIV, QString("VBC1_DIV") );
      break;

    case svvDivStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_DIV, QString("VBC1_DIV") );
      break;

    case svvMod :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_MOD, QString("VBC1_MOD") );
      break;

    case svvModStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_MOD, QString("VBC1_MOD") );
      break;

    case svvAdd :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_ADD, QString("VBC1_ADD") );
      break;

    case svvAddStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_ADD, QString("VBC1_ADD") );
      break;

    case svvSub :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_SUB, QString("VBC1_SUB") );
      break;

    case svvSubStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_SUB, QString("VBC1_SUB") );
      break;

    case svvLShift :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_LSHIFT, QString("VBC1_LSHIFT") );
      break;

    case svvLShiftStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_LSHIFT, QString("VBC1_LSHIFT") );
      break;

    case svvRShift :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_RSHIFT, QString("VBC1_RSHIFT") );
      break;

    case svvRShiftStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_RSHIFT, QString("VBC1_RSHIFT") );
      break;

    case svvOrStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_OR, QString("VBC1_OR") );
      break;

    case svvAndStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_AND, QString("VBC1_AND") );
      break;

    case svvXorStore :
      gvvBinaryStore( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_XOR, QString("VBC1_XOR") );
      break;

    case svvEqu :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_EQU, QString("VBC1_EQU") );
      break;

    case svvNotEqu :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_NOT_EQU, QString("VBC1_NOT_EQU") );
      break;

    case svvLessEqu :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_LESS_EQU, QString("VBC1_LESS_EQU") );
      break;

    case svvLess :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_LESS, QString("VBC1_LESS") );
      break;

    case svvGreat :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_GREAT, QString("VBC1_GREAT") );
      break;

    case svvGreatEqu :
      gvvBinary( prog, dynamic_cast<SvValueBinary*>(val), keepValue, address, VBC1_GREAT_EQU, QString("VBC1_GREAT_EQU") );
      break;

    case svvLogAnd :
      gvvLogAnd( prog, dynamic_cast<SvValueLogAnd*>(val), keepValue, address );
      break;

    case svvLogOr :
      gvvLogOr( prog, dynamic_cast<SvValueLogOr*>(val), keepValue, address );
      break;

    case svvOr :
      gvvBinaryLong( prog, dynamic_cast<SvValueBinaryLong*>(val), keepValue, address, VBC1_OR, QString("VBC1_OR") );
      break;

    case svvAnd :
      gvvBinaryLong( prog, dynamic_cast<SvValueBinaryLong*>(val), keepValue, address, VBC1_AND, QString("VBC1_AND") );
      break;

    case svvXor :
      gvvBinaryLong( prog, dynamic_cast<SvValueBinaryLong*>(val), keepValue, address, VBC1_XOR, QString("VBC1_XOR") );
      break;

    case svvComma :      //Операция ,
      gvvComma( prog, dynamic_cast<SvValueBinaryLong*>(val), keepValue, address );
      break;

    case svvCondition :      //Тройная условная операция
      gvvCondition( prog, dynamic_cast<SvValueCondition*>(val), keepValue, address );
      break;

    case svvCall :      //Вызов функции
      gvvCall( prog, dynamic_cast<SvValueCall*>(val), keepValue, address );
      break;
...
//Загрузить значение
void SvVpuCompiler::gvvVariable(SvProgramm *prog, SvValueVariable *var, bool keepValue, bool address)
  {
...
//Загрузить адрес функции
void SvVpuCompiler::gvvFunction(SvProgramm *prog, SvValueFunction *fun, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvConstInt(SvProgramm *prog, SvValueConstInt *cnst, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvConstString(SvProgramm *prog, SvValueConstString *cnst, bool keepValue, bool address)
  {
  Q_ASSERT( cnst != nullptr );
...
void SvVpuCompiler::gvvPointer(SvProgramm *prog, SvValuePointer *ptr, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvMemberVariable(SvProgramm *prog, SvValueMemberVariable *var, bool keepValue, bool address)
  {
  Q_ASSERT( var != nullptr );
  ...
  if( var->mStruct->isConst() ) {
    ...
    SvValueVariable *structVar = dynamic_cast<SvValueVariable*>(var->mStruct);
...
void SvVpuCompiler::gvvAddress(SvProgramm *prog, SvValueAddress *addr, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvPredInc(SvProgramm *prog, SvValuePredInc *inc, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvPredDec(SvProgramm *prog, SvValuePredDec *dec, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvPostInc(SvProgramm *prog, SvValuePostInc *inc, bool keepValue, bool address)
  {
  Q_ASSERT( inc != nullptr );
...
void SvVpuCompiler::gvvPostDec(SvProgramm *prog, SvValuePostDec *dec, bool keepValue, bool address)
  {
  Q_ASSERT( dec != nullptr );
...
void SvVpuCompiler::gvvNot(SvProgramm *prog, SvValueBitNot *vnot, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvLogNot(SvProgramm *prog, SvValueLogNot *logNot, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvNeg(SvProgramm *prog, SvValueNeg *neg, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvStore(SvProgramm *prog, SvValueStore *store, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvArrayCell(SvProgramm *prog, SvValueArrayCell *array, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvBinaryStore(SvProgramm *prog, SvValueBinary *binary, bool keepValue, bool address, SvVmCode code, const QString codeList)
  {
...
void SvVpuCompiler::gvvBinary(SvProgramm *prog, SvValueBinary *binary, bool keepValue, bool address, SvVmCode code, const QString codeList)
  {
  Q_ASSERT( binary != nullptr );
...
void SvVpuCompiler::gvvBinaryLong(SvProgramm *prog, SvValueBinaryLong *binary, bool keepValue, bool address, SvVmCode code, const QString codeList)
  {
  Q_ASSERT( binary != nullptr );
...
void SvVpuCompiler::gvvLogAnd(SvProgramm *prog, SvValueLogAnd *binary, bool keepValue, bool address)
  {
  Q_ASSERT( binary != nullptr );
...
void SvVpuCompiler::gvvLogOr(SvProgramm *prog, SvValueLogOr *binary, bool keepValue, bool address)
  {
  Q_ASSERT( binary != nullptr );
...
void SvVpuCompiler::gvvComma(SvProgramm *prog, SvValueBinaryLong *binary, bool keepValue, bool address)
  {
  Q_ASSERT( binary != nullptr );
...
void SvVpuCompiler::gvvCondition(SvProgramm *prog, SvValueCondition *condition, bool keepValue, bool address)
  {
...
void SvVpuCompiler::gvvCall(SvProgramm *prog, SvValueCall *call, bool keepValue, bool address)
  {
  ...
  SvFunctionType *funType = nullptr;
