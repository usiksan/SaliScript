...
*/
bool
SvCompiler::ScanNameImp( int &ptr ) {
  //Очистить mName
  mName.clear();
  //Накопить имя
...
*/
bool
SvCompiler::Match( const char *ptr ) {
