//===================================================================================================================
// Проект "Программируемый контроллер общего назначения"
// Автор
//   Сибилев А.С.
// Описание
//   Индексы импортируемых функций с прототипами
//
// История
//  11.02.14 создан
//  26.02.14 v4 добавлена функции
//               рестарта CAN
//               получения состояния CAN
//               сброса ожидания SDO
//              добавлены макроопределения ответов, возвращаемых функциями
//  24.03.14 v5 добавлены функции
//               изменения режима
//               при создании модуля также указывается режим
//  05.06.14 v6 добавлена поддержка модуля шагового привода
//  19.06.14 v7 добавлена поддержка модуля ШИМ
//              добавлена поддержка модуля capture
//  20.06.14 v8 добавлена поддержка модуля аналогового дифференциального ввода AD7192
//  30.06.14 v9 добавлена поддержка модуля вычисления среднего значения методом окна
//  09.07.14 v10 добавлена возможность фиксированной настройки скорости обмена по CAN-шине
//  06.12.14 v11 добавлена поддержка модуля аналогового выхода
//==================================================================================================================
